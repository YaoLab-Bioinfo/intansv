...
svAnnotation <- function(structuralVariation, genomeAnnotation) 
{
    ...
    structuralVariationGeneAnnoNna[structuralVariationGeneAnnoNna$annotation=="gene", ]$parent <- 
        genomeAnnotation[as.numeric(structuralVariationGeneAnnoNna[structuralVariationGeneAnnoNna$annotation=="gene", ]$subject)]$Name
    structuralVariationGeneAnnoNna[structuralVariationGeneAnnoNna$annotation!="gene", ]$parent <- 
        (genomeAnnotation[as.numeric(structuralVariationGeneAnnoNna[structuralVariationGeneAnnoNna$annotation!="gene", ]$subject)]$Parent)@unlistData
    ...
    genomeAnnotationGeneDf$name <- genomeAnnotationGene$Name
