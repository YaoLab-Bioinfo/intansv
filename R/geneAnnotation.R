...
geneAnnotation <- function(structuralVariation, genomeAnnotation) 
{
    ...
    GeneAnno$type <- NA
    GeneAnno[grepl("exon", GeneAnno$id), ]$type <- "exon"
    GeneAnno[grepl("intron", GeneAnno$id), ]$type <- "intron"
    GeneAnno[grepl("cds", GeneAnno$id), ]$type <- "cds"
    GeneAnno[grepl("utr", GeneAnno$id), ]$type <- "utr"
